...
export default {
  ...
  setup() {
    ...
    const getCanvasReact = (imageWidth, imageHeight) => {
      ...
      while (imageWidth > MAXSIZE || imageHeight > MAXSIZE) {
        if (imageWidth > MAXSIZE) {
          imageWidth = MAXSIZE
          imageHeight = MAXSIZE / radio
        } else if (imageHeight > MAXSIZE) {
          imageHeight = MAXSIZE
          imageWidth = MAXSIZE * radio
        }
      }
    ...
    const onDrawCanvas = (imgPath, imageWidth, imageHeight) => {
      const { imageWidth: _canvasWidth, imageHeight: _canvasHeight } = getCanvasReact(
        imageWidth,
        imageHeight
      )
